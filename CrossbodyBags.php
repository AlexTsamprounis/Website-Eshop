...
$pageTitle  = "AT.COLLECTION | Crossbody Bags";
$pageClass  = "page-category page-crossbody";
$loadCartJs = true; // ✅ για cart count + addToCart listener
...
<section class="best-sellers" id="category">
  ...
  <div class="products-flex">
    <?php
    $query  = "SELECT id, name, description, price, image_path FROM products WHERE category = 'crossbody'";
